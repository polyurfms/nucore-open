...
class NoSupervisorsController < ApplicationController
    ...
    def index
      ...
      flash.now[:warning] = "No supervisor info found. Please click #{view_context.link_to("here", request_endorsements_path)} to request supervisor endorsement. " unless @is_requested
